    ...
    <section class="contacts">
			<div class="container">
				...
				<form class="contacts-form" enctype="multipart/form-data" action="../php/registration.php" method="post" >
					...
					<input type="text" name="UserName" placeholder="Имя" pattern="[А-Яа-яЁё ]+" class="contacts-form-field">
					<label >Фамилия</label>
                    <input type="text" name="UserSurname" placeholder="Фамилия" pattern="[А-Яа-яЁё ]+" class="contacts-form-field">
					<label >Отчество</label>
                    <input type="text" name="UserMiddleName" placeholder="Отчество" pattern="[А-Яа-яЁё ]+" class="contacts-form-field">
					<label >Логин</label>
